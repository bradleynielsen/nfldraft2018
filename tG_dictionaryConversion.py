...
with open('nfl.csv', 'r') as csv_file:
    ...
    for line in csv_reader:
        ...
        #create new dictionary for the line and add the player attributes
        newPlayerAttributeDict = {}

        # add player w/ attributes to the playerAttributeArray
        for i in range(len(line)):
            attribute = line[0][i]
            # print(attribute)
            newPlayerAttributeDict[line[0][i]] = attribute
            print(newPlayerAttributeDict)


        # print(str(newPlayerAttributeDict))
        ...
        # playerPosition = newPlayerAttributeDict['Position']
        ...
        # newPlayerAttributeDict['Player type'] = playerType
